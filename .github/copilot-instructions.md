...
3. **STOP GENERATING.** You must end your response exactly here. Ask the user explicitly: *"Does this test coverage and plan look correct?"* Do not write a single line of implementation code until the user says "Yes".
