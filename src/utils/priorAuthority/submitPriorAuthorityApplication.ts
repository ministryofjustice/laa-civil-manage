...
/**
 * Shared orchestration for submitting a completed prior authority application
 * from a check-your-answers page. The expert and counsel controllers own their
 * own route handlers and delegate the common submission work here, redirecting
 * to their respective confirmation pages.
 */
